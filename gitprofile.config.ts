    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: ['OshadhaLakshan/OshadhaLakshan', 'OshadhaLakshan/oshadha.github.io', 'OshadhaLakshan/gitprofile', 'OshadhaLakshan/material-ui', 'OshadhaLakshan/ui'], // These projects will not be displayed. example: ['arifszn/my-project1', 'arifszn/my-project2']
        },
      },
      manual: {
